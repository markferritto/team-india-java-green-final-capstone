<template>
  <div id="addHomeform">
    ...
    <div class="form-group">
        ...
        <input id="address" type="text" class="form-control" v-model.number="review.stars" />
      </div>

      <div class="form-group">
        <label for="city">Title</label>
        <input id="city" type="text" class="form-control" v-model="review.title" />
      </div>
      ...
      <div class="form-group">
        ...
        <input id="state" type="text" class="form-control" v-model.number="review.userId" />
      </div>

      <div class="form-group">
        <label for="mlsNumber">Description</label>
        <input id="mlsNumber" type="text" class="form-control" v-model="review.description" />
      </div>
